...
You must supply the test data, models, and labels generated by the [CASAS Model Generator / AL Tools](https://github.com/ronsm/CASAS-RNN-Model-Generator) to the program.
