...
datasets = ["./data/CASAS/original/cairo", "./data/CASAS/original/kyoto7", "./data/CASAS/original/kyoto8", "./data/CASAS/original/kyoto11", "./data/CASAS/original/milan"]
...
if __name__ == '__main__':
    for filename in datasets:
        ...
        np.save('./data/CASAS/npy/' + datasetName + '-x.npy', X)
        np.save('./data/CASAS/npy/' + datasetName + '-y.npy', Y)
        np.save('./data/CASAS/npy/' + datasetName + '-labels.npy', dictActivities)


def getData(datasetName):
    np_load_old = np.load
    np.load = lambda *a,**k: np_load_old(*a, allow_pickle=True, **k)
    X = np.load('./data/CASAS/npy/' + datasetName + '-x.npy')
    Y = np.load('./data/CASAS/npy/' + datasetName + '-y.npy')
    dictActivities = np.load('./data/CASAS/npy/' + datasetName + '-labels.npy').item()
    np.load = np_load_old
    return X, Y, dictActivities
